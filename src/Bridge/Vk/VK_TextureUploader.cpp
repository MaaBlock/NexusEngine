...
VK_TextureUploader::VK_TextureUploader(VK_Context* context) : m_context(context) {
    ...
    // Create the dedicated command pool for the background thread
...
void VK_TextureUploader::threadLoop() {
    ...
    while (m_running) {
        ...
        // Record Upload Commands using internal command buffer
        ...
        // IF fallback, lock mutex. IF hardware dedicated, zero locks!
        ...
        // Wait to finish before discarding staging memory
        ...
        // Finally: Apply the Image View back to the original bindless descriptor!
